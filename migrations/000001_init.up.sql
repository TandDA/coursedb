...
-- Migration to insert test data into the database with predefined UUIDs
...
-- Insert into `housekeeping_services` table
...
-- Insert into `housekeeping_service_details` table
